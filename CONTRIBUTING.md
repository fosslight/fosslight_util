...
1. <a class="github-button" href="https://github.com/fosslight/fosslight_util/fork" data-icon="octicon-repo-forked" aria-label="Fork fosslight/fosslight_util on GitHub">```Fork```</a> and clone the repository
